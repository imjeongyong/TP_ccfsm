...
<body>
	...
	<div class="container">
		...
		<article>
			<h1 class="display-6 m-2 p-2 bg-danger-subtle" style="text-align: center;">레시피 작성</h1>
			<form name="writeForm" method="post" enctype="multipart/form-data"
				action="../recipeboard/write.do" onsubmit="return validateForm(this);">
					...
					<div class="col-md-8">
						...
						<div class="mb-3 text-center">
							...
							<button type="button" class="btn btn-warning"
								onclick="location.href='../recipeboard/list.do';">목록 바로가기</button>
						</div>
					</div>
				</div>
			</form>
