...
<body>
	...
	<div class="container">
		...
		<article>			
			<h1 class="display-6 m-2 p-2 bg-danger-subtle" style="text-align: center;">레시피 보기</h1>
				...
				<table class="table table-bordered p-5 m-5" style="width: 90%">
					...
					<tr>
						<td colspan="4" class="text-center">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-danger"
													onclick="location.href='../recipeboard/delete.do?idx=${param.idx}';">확인</button>
											</div>
										</div>
									</div>
								</div>
							...
							<button type="button" class="btn btn-warning"
								onclick="location.href='../recipeboard/list.do';">목록 바로가기
							</button></td>
					</tr>
				</table>
			</div>
