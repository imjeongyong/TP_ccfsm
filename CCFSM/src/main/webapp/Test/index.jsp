         ...
         <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active" data-bs-interval="3000">
                  <img src="Resources/Images/Homeimg1.jpg" class="d-block w-100"
                     alt="...">
               ...
               <div class="carousel-item" style="color: black"
                  ...
                  <img src="Resources/Images/Homeimg2.jpg" class="d-block w-100"
                     alt="...">
                  <div class="carousel-caption d-none d-md-block">
                     <div style="display: inline-block;">
                        ...
                        <a href="../Greeting/Greeting.jsp"
                           ...
                           style="text-decoration: none; color: black;">오시는길</a> <br>
                        <br>
                     </div>
                  </div>
               </div>
               <div class="carousel-item" data-bs-interval="3000">
                  <img src="Resources/Images/Homeimg3.jpg" class="d-block w-100"
                     alt="...">
                  <div class="carousel-caption d-none d-md-block">
                     ...
                     <a href="Experience/Introduce.jsp"
                        ...
                        style="text-decoration: none; color: black;">체험학습 신청</a> <br>
                     <br>
                  </div>
               </div>
               <div class="carousel-item" data-bs-interval="3000">
                  <img src="Resources/Images/Homeimg4.jpg" class="d-block w-100"
                     alt="...">
                  <div class="carousel-caption d-none d-md-block">
                     ...
                     <a href="MenuBoard/List.jsp"
                        ...
                        style="text-decoration: none; color: black;">표준 레시피</a> <br>
                     <br>
                  </div>
               </div>
               <div class="carousel-item" data-bs-interval="3000">
                  <img src="Resources/Images/Homeimg5.jpg" class="d-block w-100"
                     alt="...">
                  <div class="carousel-caption d-none d-md-block">
                     ...
                     <a href="NoticeBoard/List.jsp"
                        ...
                        style="text-decoration: none; color: black;">포토 갤러리</a> <br>
                     <br>
                  </div>
               </div>
            </div>
