...
<body>
	...
	<div class="container">
		...
		<article>
			<h1 class="display-6 m-2 p-2 bg-danger-subtle" style="text-align: center;">포토갤러리 게시글 수정하기</h1>
			<form name="writeFrm" method="post" enctype="multipart/form-data"
				action="../photoboard/edit.do" onsubmit="return validateForm(this);">
					...
					<div class="col-md-8">
						...
						<div class="mb-3 text-center">
							...
							<button type="button" class="btn btn-warning"
								onclick="location.href='../photoboard/list.do';">목록 바로가기</button>
						</div>
					</div>
				</div>
			</form>
