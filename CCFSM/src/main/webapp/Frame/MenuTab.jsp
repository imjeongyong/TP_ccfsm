...
<div class="dropdown">
	...
	<div class="dropdown-content">
		<a href="#">체험관 이용안내</a> <a href="#">체험관 신청</a>
	</div>
</div>
...
<div class="dropdown">
	...
	<div class="dropdown-content">
		...
		<a href="${pageContext.request.contextPath}/RecipeBoard/List.jsp">표준
			레시피</a>
	</div>
</div>
...
<div class="dropdown">
	...
	<div class="dropdown-content">
		<a href="#">공지사항</a> <a href="#">질문 게시판</a> <a href="#">포토 갤러리</a>
